...
force ace_medical_dropWeaponUnconsciousChance = 0.5;
...
force ace_medical_painUnconsciousThreshold = 0.66;
...
force ace_medical_treatment_maxLitterObjects = 1000;
...
force ace_medical_gui_maxDistance = 1;
...
force radioAnims_cba_vestarmor = false;
...
force AUR_ADVANCED_RAPPELING_NEW_ACTION_TIME = 5;
...
force diwako_dui_indicators_range_crew = 100;
...
force grad_trenches_functions_decayTime = 300;
...
force grad_trenches_functions_playersInAreaRadius = 100;
...
force grad_trenches_functions_timeoutToDecay = 60;
...
force tsp_cba_breach_lockDoor = 1;
force tsp_cba_breach_lockHouse = 1;
