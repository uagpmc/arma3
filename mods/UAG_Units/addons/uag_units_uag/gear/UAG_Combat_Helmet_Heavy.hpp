...
class CfgWeapons {
    ...
    class UAG_Combat_Helmet_Heavy: H_HelmetB_TI_tna_F_PROXY {
        ...
        hiddenSelectionsTextures[] = {"z\UAG_Units\addons\uag_units_uag\data\h_helmetb_ti_tna_f_co_uag.paa"};
        picture = "z\UAG_Units\addons\uag_units_uag\data\icon_h_helmetb_ti_tna_f_ca_uag.paa";
