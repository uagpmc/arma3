...
class CfgVehicles {
    ...
    class UAG_Cougar_Gunship: UAG_Cougar_Gunship_PARENTPROXY {
        ...
        hiddenSelectionsTextures[] = {
            "\z\UAG_Units\addons\uag_units_uag_rf_patch\Vehicles\UAG_Cougar_Gunship\as332_exterior_03_ldf_co_uag.paa",
            "\z\UAG_Units\addons\uag_units_uag_rf_patch\Vehicles\UAG_Cougar_Gunship\as332_int_cargo_co_uag.paa",
            "#(rgb,1024,1024,1)ui('lxRF_MFDMinimap','lxRF_MFDMinimap')",
            "\z\UAG_Units\addons\uag_units_uag_rf_patch\Vehicles\UAG_Cougar_Gunship\as332_adds_03_ldf_co_uag.paa",
            "\z\UAG_Units\addons\uag_units_uag_rf_patch\Vehicles\UAG_Cougar_Gunship\as332_exterior_03_ldf_co_uag.paa",
            "\z\UAG_Units\addons\uag_units_uag_rf_patch\Vehicles\UAG_Cougar_Gunship\as332_int_cargo_co_uag.paa"
        };
        textureList[] = {};
