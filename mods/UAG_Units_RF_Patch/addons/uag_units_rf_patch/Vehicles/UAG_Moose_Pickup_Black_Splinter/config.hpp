class CfgVehicles {
    ...
    class UAG_Moose_Pickup_Black_Splinter: UAG_Moose_Pickup_BASE {
        ...
        hiddenSelectionsTextures[] = {
            "z\UAG_Units_RF_Patch\addons\uag_units_rf_patch\Vehicles\UAG_Moose_Pickup\pickup_01_service_ldf_co_uag.paa",
            ...
            "z\UAG_Units_RF_Patch\addons\uag_units_rf_patch\Vehicles\UAG_Moose_Pickup\pickup_01_ext_ldf_co_uag.paa"
        };
    };
};